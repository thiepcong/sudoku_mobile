...
class _SudokuGamePageState extends State<SudokuGamePage>
  ...
  void _gameOver() async {
    ...
    final String winnerConclusionText = S.of(context).winnerConclusionText;
    final String failureConclusionText = S.of(context).failureConclusionText;
        ...
        fillOnPressed = () async {
          ...
          if (_markOpen) {
            ...
            if (_state.record[_chooseSudokuBox] != -1 &&
              ...
              String wrongInputAlertText = S.of(context).wrongInputAlertText;
              wrongInputAlertText = wrongInputAlertText.replaceFirst(
                  "%attempts%", "${_state.life}");
              String gotItText = S.of(context).gotItText;
  ...
  Widget _toolZone(BuildContext context) {
    ...
    var exitGameText = S.of(context).exitGameText;
    var cancelText = S.of(context).cancelText;
    var pauseText = S.of(context).pauseText;
    var tipsText = S.of(context).tipsText;
    var enableMarkText = S.of(context).enableMarkText;
    var closeMarkText = S.of(context).closeMarkText;
    var exitGameContentText = S.of(context).exitGameContentText;
