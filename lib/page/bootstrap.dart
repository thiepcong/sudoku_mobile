...
Widget _continueGameButton(BuildContext context) {
  return ScopedModelDescendant<SudokuState>(builder: (context, child, state) {
    String buttonLabel = S.of(context).menuContinueGame;
...
Future _sudokuGenerate(BuildContext context, Level level) async {
  String sudokuGenerateText = S.of(context).sudokuGenerateText;
  showDialog(
      context: context,
          ...
          onPressed: () {
            ...
            Widget cancelButton = SizedBox(
                ...
                child: Container(
                    ...
                    child: CupertinoButton(
//                      color: Colors.red,
                      child: Text(S.of(context).levelCancel),
                      onPressed: () {
